-- Finalize superadmin rollout in case only enum migration was applied previously.
-- This migration is idempotent and re-applies role helpers + FK behavior safely.
...
BEGIN
  IF NOT EXISTS (
    ...
    RAISE EXCEPTION 'El valor superadmin no existe en public.app_role. Ejecuta primero la migración 20260228010000.';
  END IF;
END $$;
